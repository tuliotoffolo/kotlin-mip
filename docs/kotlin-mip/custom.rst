...
.. literalinclude:: ../mip.examples/cutting_planes.py
    :caption: A pure cutting-planes approach for the Traveling Salesman Problem (mip.examples/cutting_planes.py)
    :linenos:
    :lines: 3-49
...
.. literalinclude:: ../mip.examples/tsp-cuts.py
    :caption: Branch-and-cut for the traveling salesman problem (mip.examples/tsp-cuts.py)
    :linenos:
    :lines: 8-95
