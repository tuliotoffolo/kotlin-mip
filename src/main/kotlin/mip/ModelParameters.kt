 ...
 */
abstract class ModelParameters() : Parameters() {
    ...
    override var storeSearchProgressLog: Boolean
        ...
        set(value) { solver.storeSearchProgressLog = value }

    override var threads: Int
        get() = solver.threads
        set(value) { solver.threads = value }

    override var verbose: Boolean
        get() = solver.verbose
        set(value) { solver.verbose = value }
